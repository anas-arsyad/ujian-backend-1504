...
CREATE TABLE `movies` (
  ...
  PRIMARY KEY (`id`),
  KEY `movie_moviesstatus_idx` (`status`),
  CONSTRAINT `movie_moviesstatus` FOREIGN KEY (`status`) REFERENCES `movie_status` (`id`)
...
CREATE TABLE `schedules` (
  ...
  PRIMARY KEY (`id`),
  KEY `schedule_movie_idx` (`movie_id`),
  KEY `schedule_location_idx` (`location_id`),
  KEY `schedule_time_idx` (`time_id`),
  CONSTRAINT `schedule_location` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`),
  CONSTRAINT `schedule_movie` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`),
  CONSTRAINT `schedule_time` FOREIGN KEY (`time_id`) REFERENCES `show_times` (`id`)
...
INSERT INTO `schedules` VALUES (1,1,1,3),(2,1,1,4),(3,1,1,5),(4,1,2,1),(5,1,2,5),(6,1,2,6),(7,1,3,1),(8,1,3,2),(9,1,3,3),(10,2,2,2),(11,2,2,4),(12,2,2,6),(13,3,1,3),(14,3,3,5),(15,3,3,6),(16,4,1,1),(17,4,2,2),(18,4,2,4),(19,4,3,3),(20,5,1,5),(21,5,2,5),(22,5,3,5),(23,6,1,1),(24,6,2,2),(25,6,3,3),(26,8,1,4),(27,8,1,6),(28,9,3,1),(29,9,3,1),(31,9,3,1);
...
CREATE TABLE `users` (
  ...
  KEY `user_roles_idx` (`role`),
  CONSTRAINT `user_roles` FOREIGN KEY (`role`) REFERENCES `roles` (`id`),
  CONSTRAINT `user_status` FOREIGN KEY (`status`) REFERENCES `status` (`id`)
...
INSERT INTO `users` VALUES (1,'1612335809792','aleepop','alee@gmail.com','6ad8f81a82dac2a8b0f59f815dc81ffe',2,3),(2,'1612343025394','aleepop','alee@gmail.com','6ad8f81a82dac2a8b0f59f815dc81ffe',2,1),(3,'1612343062175','sapi123','alee@gmail.com','d72974e7fa6150c112152074baafdcd2',2,1),(4,'1612345642407','gajah123','alee@gmail.com','d72974e7fa6150c112152074baafdcd2',2,1);
...
-- Dump completed on 2021-02-03 17:15:36
